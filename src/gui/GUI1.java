...
public class GUI1 extends JFrame {
	...
	private JLabel lblTodosLosNmeros;
	private JLabel lblNmerosOrdenados;
	...
	public GUI1() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				JOptionPane.showMessageDialog(null,
						"Diseño y Análisis de Algoritmos\n "
								...
								+ "					Bryan Townsend -> Desarrolladores",
		...
		tabbedPane.setToolTipText("Algoritmos de Ordenamiento\r\n");
		...
		CantidadNumerosInsertion1 = new JLabel("de Números a Ordenar:");
		...
		labeltodoslosnumerosInsertion = new JLabel("Todos los Números:");
		...
		labelnumerosordenadosInsertion = new JLabel("Números Ordenados:");
		...
		CantidadNumerosMerge1 = new JLabel("de Números a Ordenar:");
		...
		labeltodoslosnumerosMerge = new JLabel("Todos los Números:");
		...
		labelnumerosordenadosMerge = new JLabel("Números Ordenados:");
		...
		CantidadNumerosQuick1 = new JLabel("de Números a Ordenar:");
		...
		labeltodoslosnumerosQuick = new JLabel("Todos los Números:");
		...
		labelnumerosordenadosQuick = new JLabel("Números Ordenados:");
		...
		CantidadNumerosArrays1 = new JLabel("de Números a Ordenar:");
		...
		labeltodoslosnumerosArrays = new JLabel("Todos los Números:");
		...
		labelnumerosordenadosArrays = new JLabel("Números Ordenados:");
		...
		CantidadNumerosCollection1 = new JLabel("de Números a Ordenar:");
		...
		labeltodoslosnumerosCollection = new JLabel("Todos los Números:");
		...
		labelnumerosordenadosCollection = new JLabel("Números Ordenados:");
		...
		BotonComparacionInsert.setToolTipText("InsertionSort");
		...
		BotonComparacionMerge.setToolTipText("MergeSort");
		BotonComparacionMerge.setFont(new Font("Segoe UI Black", Font.PLAIN, 11));
		BotonComparacionMerge.setBackground(new Color(255, 99, 71));
		...
		BotonComparacionQuick.setToolTipText("QuickSort");
		...
		BotonComparacionArrays.setToolTipText("ArraySort");
		...
		BotonComparacionCollection.setToolTipText("CollectionSort");
		...
		scrollPane_5.setBounds(155, 210, 360, 50);
		...
		JTextComparacionInsert.setColumns(20);
		...
		lblIngresarCantidadDe = new JLabel("Ingresar Cantidad de Números a\r\n");
		...
		JButtonComparar.setToolTipText("Comparar Ordenamientos");
		...
		lblTodosLosNmeros = new JLabel("Todos los Números:");
		lblTodosLosNmeros.setToolTipText("Todos Los Numeros");
		lblTodosLosNmeros.setFont(new Font("Rockwell Extra Bold", Font.PLAIN, 11));
		lblTodosLosNmeros.setBounds(22, 215, 129, 14);
		PanelComparacion.add(lblTodosLosNmeros);

		lblNmerosOrdenados = new JLabel("Números Ordenados:");
		lblNmerosOrdenados.setToolTipText("Todos Los Numeros Ordenados");
		lblNmerosOrdenados.setFont(new Font("Rockwell Extra Bold", Font.PLAIN, 11));
		lblNmerosOrdenados.setBounds(10, 229, 141, 14);
		PanelComparacion.add(lblNmerosOrdenados);
	}
}
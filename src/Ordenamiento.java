...
public class Ordenamiento {
	...
	/*public static void NumerosOrdenados(int[]arregloordenado){
	...
	public static void main(String[]args) {
        ...
        System.out.println("El algoritmo QuickSort se demoró " +DURACION_MS1+ " MiliSegundos");
		...
		System.out.println("El algoritmo MergeSort se demoró " +DURACION_MS2+ " MiliSegundos");
